...
<main>
    <div class="main-form">
        <div class="create-form-background">
            ...
            <form id="create-account-form" action="controllers/create-account.php" method="post">
        ...
        <div class="create-form-background">
            ...
            <form id="login-account-form" action="controllers/login-account.php" method="post">
                <label for="name">Gebruikersnaam</label>
                <input type="text" name="username" required="">
                <label for="players">Wachtwoord</label>
                <input type="password" name="password" required="">
